...
public class User
{
	...
	public static system.proxies.User initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Dentist", mendixObject.getType())) {
			return myfirstmodule.proxies.Dentist.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Manager", mendixObject.getType())) {
			return myfirstmodule.proxies.Manager.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Medical_staff", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Patient", mendixObject.getType())) {
