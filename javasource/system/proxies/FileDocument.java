...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.EOTM_doc", mendixObject.getType())) {
			return myfirstmodule.proxies.EOTM_doc.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Eq_doc", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Mat_doc", mendixObject.getType())) {
